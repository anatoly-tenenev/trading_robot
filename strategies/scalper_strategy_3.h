#ifndef SCALPER_STRATEGY_3_HPP
#define SCALPER_STRATEGY_3_HPP
...
class scalper_strategy_3_t : public strategy_base_t
{
public:
    enum log_level
    {
...
protected:
    ...
    int orderbook_volume(order_dir_t dir) const;
