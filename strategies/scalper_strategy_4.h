#ifndef SCALPER_STRATEGY_4_HPP
#define SCALPER_STRATEGY_4_HPP
...
class scalper_strategy_4_t : public strategy_base_t
{
public:
    enum log_level
    {
...
private:
    ...
    vector<Stata2> m_stat2bid;
    vector<Stata2> m_stat2ask;
    void write_stata2() const;
};
