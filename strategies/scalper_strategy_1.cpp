...
scalper_strategy_1_t::scalper_strategy_1_t(
...
{
    m_lg.add_attribute("pid", attr::constant<scalper_strategy_1_t*>(this));
...
void scalper_strategy_1_t::order_succeeded(const order_base_t& order)
{
...
void scalper_strategy_1_t::order_failed(const order_base_t& order)
{
...
void scalper_strategy_1_t::order_del_succeeded(const order_base_t& order)
{
...
void scalper_strategy_1_t::order_del_failed(const order_base_t& order)
{
...
void scalper_strategy_1_t::order_move_succeeded(const order_base_t& order)
{
...
void scalper_strategy_1_t::order_move_failed(const order_base_t& order)
{
...
void scalper_strategy_1_t::add_deal(const deal_base_t& deal)
{
...
void scalper_strategy_1_t::add_tick(const deal_base_t& tick)
{
...
void scalper_strategy_1_t::process()
{
...
void scalper_strategy_1_t::update_orders_before()
{
    map<int, int> ob;
...
void scalper_strategy_1_t::update_orderbook()
{
...
void scalper_strategy_1_t::init(scalper_trade_t& trade)
{
...
bool scalper_strategy_1_t::try_to_start(scalper_trade_t& trade)
{
...
void scalper_strategy_1_t::cancel(scalper_trade_t& trade)
{
...
scalper_strategy_1_t::strategy_state_t scalper_strategy_1_t::get_state()
{
...
void scalper_strategy_1_t::work()
{
...
void scalper_strategy_1_t::prepare_to_stop()
{
    m_trades.erase(std::remove_if(m_trades.begin(),
                                  m_trades.end(),
                                  [](const scalper_trade_t& trade) {
...
void scalper_strategy_1_t::add_order(scalper_trade_t& trade,
...
bool scalper_strategy_1_t::del_order(scalper_order_t& order)
{
    if (order.is_pending())
        return false;
    order.start_pending(m_market.datetime());
...
bool scalper_strategy_1_t::move_order(scalper_order_t& order, double price)
{
...
tuple<int, int> scalper_strategy_1_t::find_order(int order_id)
{
...
void scalper_strategy_1_t::verify_orders()
{
    for (auto& trade : m_trades)
    {
        auto& orders = trade.orders;
...
int scalper_strategy_1_t::orders_before(const scalper_order_t &order, int n)
{
    if (order.dir() == order_dir_t::bid)
    {
...
int scalper_strategy_1_t::levels_before(const scalper_order_t &order)
{
    if (order.dir() == order_dir_t::bid)
    {
...
int scalper_strategy_1_t::orders_after(const scalper_order_t &order, int n)
{
    if (order.dir() == order_dir_t::bid)
    {
...
int scalper_strategy_1_t::attack_orders(const scalper_order_t &order, int n)
{
    if (order.dir() == order_dir_t::bid)
    {
...
void scalper_strategy_1_t::check_logger()
{
    ptime now = m_market.datetime();
...
//        m_sink->locked_backend()->add_stream(stream);
        ...
        m_sink->set_filter(
                    expr::attr<scalper_strategy_1_t*>("pid") == this );
